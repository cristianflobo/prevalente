...
export const Form = ({ modal, nameempresa }) => {
  ...
  const {
    ...
    viewModal,
    contadorEmpresa,
  } = useForm(modal, nameempresa);
  return (
    <div className="padreconteinerform">
      <div className="conteinerform">
        <div className="divlogo_negro">
          <div className="divbuttoncheck">
            <button
              className="buttoncheck"
              disabled={dataView.aprobada}
            ...
            >
              {" "}
              <img style={{ marginRight: "10px" }} src={x} alt="" />
              Rechazar Empresa
            </button>
          </div>
          ...
          <div className="padrelogo_negro">
            <div className="logo_negro">
              <img
                style={{ width: "174px", height: "151px" }}
                src={logo_negro}
                alt=""
              />
            </div>
        ...
        <div className="divform">
          ...
          >
            <div style={{ marginRight: "20px" }}>
              ...
              <input
                value={dataView.empleados}
                className="inputform"
                type="text"
              />
            </div>
            <div className="buttonviewmodal">
              <button className="button" onClick={() => viewModal()}>
                <img style={{ marginRight: "10px" }} src={clip} alt="" />
      ...
      <div className="paginacion">
        <img
          ...
          alt=""
          onClick={() => viewBack(contadorEmpresa - 1)}
        />
        <p className="spanpaginacion">
          Empresa {contadorEmpresa + 1} de {dataempresa.length - aprobada}{" "}
        ...
        <img
          ...
          src={
            contadorEmpresa + 1 >= 1 &&
            dataempresa.length !== contadorEmpresa + 1
              ? flecha_derecha_negra
              : flecha_derecha_gris
          }
          alt=""
          onClick={() => viewNext(contadorEmpresa + 1)}
        />
      </div>
    </div>
  );
